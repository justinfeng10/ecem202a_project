...
tf.io.write_file("SourceSeparationTestOutput/Base/original.wav", file, name=None)
...
inverse_stftx = tf.squeeze(inverse_stftx)
file = tf.audio.encode_wav(tf.expand_dims(inverse_stftx, 1), 16000, name=None)
tf.io.write_file("SourceSeparationTestOutput/Base/vacuumOutput.wav", file, name=None)
...
inverse_stftx = tf.squeeze(inverse_stftx)
file = tf.audio.encode_wav(tf.expand_dims(inverse_stftx, 1), 16000, name=None)
tf.io.write_file("SourceSeparationTestOutput/Base/alarmOutput.wav", file, name=None)
